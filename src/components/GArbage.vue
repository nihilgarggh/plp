<template>
  <div class="container-fluid product-list-main">
      ...
      <div class="filter-top">
        <div class="sidebar-filter-top">
          <div>
            <div>
              <h3>
                <p @click="showHideFilter" :isOpen="isOpen" class="hideFilterWrap">
          ...
          <div class="row-filter">
            ...
            <div class="product-sort">
              <div class="sort-product">
                ...
                <ul class="sort-list">
                  <li v-for="(sort, i) in response.sort" :key="i" :class="[sort.label == label ? 'liactive' : '']" @click="getsort(sort.code, sort.label)" :value="sort.label">
                    {{ sort.label }}
                  </li>
                </ul>
              </div>
              <div class="sortoverlay" style="" v-show="mobiletoggle" @click="togglemobile()" >
    ...
    <div class="product-main">
      <div
        :class="[
          !isOpen ? 'sidebar-filter d-none ' : 'sidebar-filter hidefilter d-none ',]" >
